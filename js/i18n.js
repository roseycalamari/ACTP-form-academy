window.ACTP_I18N = {
  pt: {
    ...
    gridHint:
      "Marque todas as combinações dia + hora possíveis — não só a preferida. Assim conseguimos formar turmas.",
    schedule: "Horário",
    mon: "Seg",
    tue: "Ter",
    wed: "Qua",
    ...
    chooseSlot: "Escolher…",
    tennisLevelTitle: "Nível aproximado (ténis) — se souber",
    tennisLevelHint:
      "Red, Orange, Green e Yellow são os estágios da bola. Os números (ex.: ~5–8) são faixas etárias típicas, não o nível de jogo.",
  ...
  en: {
    ...
    gridHint:
      "Mark every possible day + time combination — not just the preferred one. That’s how we are able to form classes.",
    schedule: "Schedule",
    mon: "Mon",
    tue: "Tue",
    wed: "Wed",
    ...
    chooseSlot: "Choose…",
    tennisLevelTitle: "Approximate skill level (tennis) — if you know",
    tennisLevelHint:
      "Red, Orange, Green and Yellow are the ball stages. The numbers (e.g. ~5–8) are typical age groups, not a skill rating.",
